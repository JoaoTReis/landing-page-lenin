  ...
  return (
    <div className="relative grid grid-rows-4 p-5 gap-10 bg-[#204659] justify-center max-lg:p-2 max-lg:gap-4">
      <img
        ...
        alt="24h"
        className="absolute left-0 bottom-0 z-0 max-lg:hidden"
      />
      <img
        src="/imagens_outros/imagem_lenin_servico_outros.webp"
        alt="24h"
        className="absolute right-0 bottom-0 h-180 z-0 max-lg:h-32 max-lg:right-0 max-lg:hidden"
      />
      <img
          src="/horario.webp"
          alt="24h"
      ...
      <div className="flex gap-20 max-lg:flex-col max-lg:gap-4">
        ...
        <BotaoServico
          ...
          tituloClassName="text-2xl max-lg:text-base"
          className="w-120 h-60 max-lg:w-full max-lg:h-32"
          imgClassName="w-30 h-30 object-contain max-lg:w-12 max-lg:h-12"
        />
      </div>
    </div>
  );
